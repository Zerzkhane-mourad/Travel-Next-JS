...
const Hero = () => {
    return (
        <section className='max-container padding-container flex flex-col py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row gap-20 ' >
                ...
                <div className='relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8 ' >
                    ...
                    <div className='flexBetween'>
                        <div className='flex flex-col'>
                            ...
                            <p className='bold-20 text-white'>167 mi</p>
                        </div>
                        <div className='flex flex-col'>
